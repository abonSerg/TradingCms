$(document).ready(function() {
    ...
    $('.top-products-slider-wrap').slick({
        ...
        slidesToShow: 4,
        slidesToScroll: 1,
        prevArrow: '<button type="button" class="top-products-slider-prev"><i class="fa fa-angle-left"></i></button>',
        nextArrow: '<button type="button" class="top-products-slider-next"><i class="fa fa-angle-right"></i></button>',
        responsive: [
          {
              breakpoint: 1024,
              settings: {
