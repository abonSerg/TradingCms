...
DECLARE @lang int
SELECT @lang=[Id] from  [dbo].[Languages] where [LanguageName]='Ru'
---Category---
...
select MAX(Id), @lang, N'Компьютерная техника' from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)

INSERT INTO [dbo].[CategoryTranslations] ([CategoryId],[LanguageId],[Name])
select MAX(Id),  @lang, N'Ноутбуки' from [dbo].[Categories]
...
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo IdeaPad 100-14 (80HH001XUA)', N'Экран 14" (1366x768) HD LED, глянцевый / Intel Celeron N2840 (2.16 ГГц) / RAM 2 ГБ 
					HDD 500 ГБ / Intel HD Graphics / без ОД / LAN / Wi-Fi / веб-камера / DOS / 1.9 кг / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'HP 255G4 (NOY69ES)', N'Экран 15.6” (1366x768) HD LED, матовый / AMD Dual-Core E1-6015 (1.4 ГГц) / RAM 2 ГБ 
...
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Dell Inspiron 3551 (135C25NIW-22)', N'Экран 15.6" (1366x768) HD WLED, глянцевый / Intel Celeron N2830 (2.16 ГГц) / RAM 2 ГБ 
					HDD 500 ГБ / Intel HD Graphics / Без ОД / Wi-Fi / Bluetooth 4.0 / веб-камера / Windows 8.1 / 2.14 кг / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Asus EeeBook E502MA (E502MA-XX0026D) Blue ', N'Экран 15.6" (1366x768) HD, глянцевый / Intel Celeron N2840 (2.16 ГГц) / RAM 4 ГБ 
					HDD 500 ГБ / Intel HD Graphics / без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / DOS / 1.86 кг / синий' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N' Acer Aspire ES1-520-392H (NX.G2JEU.002)', N'Экран 15.6'' (1366x768) HD LED, матовый / AMD E1-2500 (1.4 ГГц) / RAM 4 ГБ 
					HDD 500 ГБ / Radeon HD 8240 / без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / Linpus / 2.4 кг / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo IdeaPad 100S White ', N'Экран 11.6" TN (1366x768) WXGA HD LED, глянцевый / Intel Atom Z3735F (1.33 - 1.83 ГГц) / RAM 2 ГБ 
...
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Acer Aspire E5-573G-312U (NX.MVMEU.025) Black-Iron ', N'Экран 15.6'' (1366x768) HD LED, матовый / Intel Core i3-5005U (2.0 ГГц) / RAM 4 ГБ 
					HDD 500 ГБ / nVidia GeForce 920M, 2 ГБ / Без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / Linux / 2.4 кг / серый с черным' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N' Asus EeeBook E502MA (E502MA-XX0020D) Blue ', N'Экран 15.6" (1366x768) HD, глянцевый / Intel Pentium N3540 (2.16 - 2.66 ГГц) / RAM 4 ГБ 
...
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo G50-45 (80E301XLUA) ', N'Экран 15.6" (1366x768) HD LED, глянцевый / AMD Quad-Core A4-6210 (1.8 ГГц) / RAM 2 ГБ 
					HDD 500 ГБ / AMD Radeon R3 / Без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / Windows 10 Home / 2.5 кг / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'HP 250 G4 (P5R75ES)',N'Экран 15.6” (1366x768) HD LED, матовый / Intel Core i3-4005U (1.7 ГГц) / RAM 4 ГБ 
					HDD 500 ГБ / Intel HD Graphics / без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / DOS / 2.15 кг / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) ,  6555,1,25/12/2014   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo IdeaPad 100-15 (80QQ004NUA)', N'Экран 15.6" (1366x768) HD LED, глянцевый / Intel Pentium 3825U (1.9 ГГц) / RAM 4 ГБ 
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Планшеты',NULL from [dbo].[Categories]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy Tab E 9.6" 3G White (SM-T561NZWASEK)', N'Экран 9.6" (1280x800) емкостный MultiTouch / T-Shark2 (1.3 ГГц) / RAM 1.5 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo TAB 2 A7-10 7" 8GB WiFi Black (59434747)', N'Экран 7" (1024х600) IPS, емкостный MultiTouch / MediaTek MT8127 (1.3 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Asus ZenPad 7.0 16GB White (Z370C-1B042A)', N'Экран 7" IPS (1280x800) емкостный MultiTouch / Intel Atom x3-C3200 / RAM 2 ГБ / 16 ГБ встроенной памяти + microSD
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy Tab S2 9.7" 32GB Black (SM-T810NZKESEK)', N'Экран 9.7" Super AMOLED (2048x1536) емкостный MultiTouch / Samsung Exynos 5433 (1.9 ГГц + 1.3 ГГц) / RAM 3 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo Tab 2 A7-30DC 7" 3G 8GB Black (59444592)', N'Экран 7" (1024х600) IPS, емкостный MultiTouch / MediaTek MT8382M (1.3 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Prestigio MultiPad 10.1 3G Black (PMT3341_3G)', N'Экран 10.1" IPS (1280x800) емкостный Multi-Touch / Intel Atom X3 C3230 (1.2 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Jeka JK-103 16GB 3G IPS', N'Экран 10.1" IPS (1024х600), емкостный, MultiTouch / ARM Cortex A7 (1.3 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Prestigio MultiPad Color 2 3G Black (PMT3777_3G_C)',N'Экран 7" IPS (1280x800) емкостный, MultiTouch / Intel Atom x3-C3230RK (1.2 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Fly Flylife Connect 10.1 3G 2 Black', N'Экран 10.1" IPS (1280х800) емкостный MultiTouch / MediaTek MT8382V/W (1.3 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Assistant AP-115G White ', N'Экран 10.1 (1024x600) емкостный MultiTouch / MTK6572 Dual Core (1.2 ГГц) / RAM 1 ГБ 
...
select  MAX(Id) , 3000,1,25/12/2015   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo Tab 2 A10-70L 16GB LTE Blue (ZA010015UA)', N'Экран 10.1 (1920x1200) IPS емкостный, MultiTouch / MediaTek MT8732 (1.5 ГГц) / RAM 2 ГБ 
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Электронные книги',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 624 Basic Touch Grey (PB624-Y-WW)', N'Диагональ дисплея: 6" / Разрешение: 800х600 / Тип матрицы: E Ink / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 191 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 626 Touch Lux2 Black (PB626-E-CIS)',N'Диагональ дисплея: 6" / Разрешение: 1024х758 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 208 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook InkPad 840 Brown', N'Диагональ дисплея: 8" / Разрешение: 1600x1200 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 350 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 630 Kenzo Grey (PB630-G-CIS-KNZ)', N'Диагональ дисплея: 6" / Разрешение: 1024х758 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 155 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 614 Basic 2 White (PB614-D-CIS)', N'Диагональ дисплея: 6" / Разрешение: 800х600	/ Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 188 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'EvroMedia Е-Учебник Classic Pro', N'Диагональ дисплея: 9.7" / Разрешение: 1200x800	/ Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 350 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 630 Sense Brown (PB630-X-CIS)', N'Диагональ дисплея: 6" / Разрешение: 1024х758 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 155 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Evromedia E-учебник Classic One', N'Диагональ дисплея: 6" / Разрешение: 800х600 / Тип матрицы: E Ink / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 191 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'EvroMedia Е-Учебник HD Paper', N'Диагональ дисплея: 6" / Разрешение: 1024х758 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 155 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook Ultra 650 Белый ', N'Диагональ дисплея: 6" / Разрешение: 1024х758 / Тип матрицы: E Ink Pearl / Количество градаций серого: 16
					Встроенная память: 4 ГБ / Вес: 175 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 2500,1,2015-04-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'PocketBook 515 Grey (PB515-Y)', N'Диагональ дисплея: 5" / Разрешение: 800х600 / Тип матрицы: E Ink / Количество градаций серого: 16
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Телефоны, MP3, GPS',NULL from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)

INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Смартфоны',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy J5 J500H/DS Black', N'Экран (5", Super AMOLED, 1280x720)/ Qualcomm Snapdragon 410 (1.2 ГГц)/ основная камера: 13 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo A7000 Onyx Black ', N'Экран (5.5", IPS, 1280x720)/ MediaTek MT6752 (1.5 ГГц)/ основная камера: 8 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy A3 2016 Duos SM-A310 16Gb Black',N'Экран (4.7", Super AMOLED, 1280x720)/ Четырехъядерный Qualcomm Snapdragon 410 (1.5 ГГц)/ основная камера: 13 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy S6 SS 32GB G920 Gold', N'Экран (5.1", Super AMOLED, 2560х1440)/ Samsung Exynos 7420 (Quad 2.1 ГГц + Quad 1.5 ГГц)/ основная камера: 16 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'LG G4 Leather Brown', N'Экран (5.5", IPS, 2560х1440)/ Qualcomm Snapdragon 808 (1.8 ГГц)/ основная камера: 16 Мп, фронтальная камера: 8 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Apple iPhone 5s 16GB Space Gray', N'Экран (4", IPS, 1136x640)/ Apple A7 (1.3 ГГц)/ основная камера: 8 Мп, фронтальная камера: 1.2 Мп
					RAM 1 ГБ/ 16 ГБ встроенной памяти/ 3G/ LTE/ GPS/ Nano-SIM/ iOS 9/ 1560 мА*ч' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Meizu M2 Note 16GB White с наушниками EP-21HD (Международная версия)', N'Экран (5.5", IGZO, 1920x1080)/ MediaTek MT6753 (1.3 ГГц)/ основная камера: 13 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Samsung Galaxy S3 Neo Duos I9300i Black', N'Экран (4.8", Super AMOLED, 1280x720)/ Qualcomm MSM8226 Snapdragon 400 (1.4 ГГц)/ основная камера: 8 Мп, фронтальная камера: 1.9 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Xiaomi Redmi Note 2 16GB Gray', N'Экран (5.5", IPS, 1920x1080)/ MediaTek Helio X10 MT6795 (2.0 ГГц)/ основная камера: 13 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Microsoft Lumia 640 XL (Nokia) DS Cyan', N'Экран (5.7", IPS, 1280x720)/ Qualcomm Snapdragon 400 (1.2 ГГц)/ основная камера: 13 Мп, фронтальная камера: 5 Мп
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Lenovo A2010 Black ', N'Экран (4.5", TN, 854x480)/ MediaTek MTK6735M (1.0 ГГц)/ основная камера: 5 Мп, фронтальная камера: 2 Мп
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'MP3-плееры',NULL from [dbo].[Categories]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Sony Walkman NWZ-A15 16GB Blue',N'16 ГБ / MP3, WMA, FLAC, L-PCM, AAC, HE-AAC, ALAC, AIFF, WAV, AVCHD, MPEG4, WMV9, JPEG 
					2.2" TFT QVGA (320 x 240) / FM-радио / NFC / Bluetooth / USB / 66 г / голубой' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Jeka Neo 8GB Black/Blue ',N'8 ГБ / MP3, WMA, WAV, PEG, BMP, AVI, TXT 
					1.8" TFT (160x128) / FM-приемник / miniUSB / 40 х 80 х 9 мм, 19 г / черный с синим' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Transcend T-Sonic 350 8GB Blue', N'8 ГБ / MP3, WMA, WAV / OLED / USB 2.0 / FM-приемник / Диктофон / 22 г / синий' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Apple iPod touch 64GB Blue', N'64 ГБ / AAC, защищенный AAC, HE-AAC, MP3, MP3 VBR, Audible, Apple Lossless, AIFF, WAV, H.264, MPEG-4, M-JPEG 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Pixus Six 8GB New White ', N'8 ГБ / MP3, WMA, WAV / OLED черно-белый / FM-приемник 
					Диктофон / USB 2.0 / 80 x 20 x 11 мм, 18 г / белый' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU','NRG Stick Pro ', N'8 ГБ / MP3, WMA, WAV, FLAC / OLED 4х-строчный / FM-приемник / диктофон 
					USB / 84 х 27 х 13 мм, 26 г / черный' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Apple iPod nano 7Gen 16GB Space Gray',N'16 ГБ / АAC, защищенный AAC, HE-AAC, MP3, MP3 VBR, Audible, Apple Lossless, AIFF, WAV, H.264, M4V, MP4, MOV, MPEG-4 
					2.5" Multi-Touch дисплей / FM-радио / Bluetooth 4.0 / 31 г / серый' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Sony Walkman NWZ-WS613 4GB White ', N'4 ГБ / MP3, WMA, Linear PCM, AAC / USB / Bluetooth / NFC / водонепроницаемый / 37 г / белый' from [dbo].[Products]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'FiiO M3 White ', N'8 ГБ / APE / FLAC / WAV / MP3 / AAC / WMA / OGG / 2" TFT-экран / 40 г' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Apple iPod shuffle 2GB Pink', N'2 ГБ / АAC, защищенный AAC, MP3, MP3 VBR, Audible, Apple Lossless, AIFF, WAV / 12.5 г / розовый' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Apple iPod touch 16GB Gold', N'16 ГБ / AAC, защищенный AAC, HE-AAC, MP3, MP3 VBR, Audible, Apple Lossless, AIFF, WAV, H.264, MPEG-4, M-JPEG 
					сенсорный 4" Multi-Touch дисплей / камера 8 Мп + фронтальная камера 1.2 Мп 
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Зарядные устройтсва ',NULL from [dbo].[Categories]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевой адаптер E-Power 1 USB + holder 2.1 A', N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Автомобильное зарядное устройство E-Power MicroUSB', N'Тип: Автомобильные / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
					Количество USB-портов: 1 / Дополнительные характеристики: LED индикация процесса зарядки / Цвет: Black / Гарантия: 6 месяцев' from [dbo].[Products]
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство E-Power кабель Smart', N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство Pixus Charge One Turquoise', N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов / Количество USB-портов: 1
...
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Универсальный зарядный комплект E-Power 3 в 1',N'Тип: Автомобильные, Сетевые \ Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
					Количество USB-портов: 2 / Дополнительные характеристики: LED индикация процесса зарядки / Цвет: Black / Гарантия: 6 месяцев' from [dbo].[Products]
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство Logan Quad USB Wall Charger 5V 4A CH-4 Orange', N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Автомобильное зарядное устройство E-Power кабель MicroUSB',  N'Тип: Сетевые / Подходит для зарядки: Планшетов, Мобильных телефонов / Совместимость: iPhone 5, iPhone 6' from [dbo].[Products]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство',  N'Тип: Сетевые / Подходит для зарядки: Планшетов, Мобильных телефонов / Совместимость: iPhone 5, iPhone 6' from [dbo].[Products]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство Global MSH-TR-071 c кабелем для iPhone 5, 6 White', N'Тип: Сетевые / Подходит для зарядки: Планшетов, Мобильных телефонов / Совместимость: iPhone 5, iPhone 6
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство Drobak Power Dual 220V-USB White/Black', N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов / Количество USB-портов: 2
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство Logan Quad USB Wall Charger 5V 2.6A CHC-4 White',N'Тип: Сетевые / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
					Совместимость: Мобильные телефоны, смартфоны, фотоаппараты, mp3-плееры, планшеты с возможностью зарядки от USB порта
...
values (NULL)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Бытовая техника',NULL from [dbo].[Categories]
INSERT INTO [dbo].[Categories]([TopId])
values (1)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Холодильники',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'Ru',N'SNAIGE FR-240.1101AA',N'Тип холодильника: двухкамерный /  Общий объем холодильника: 220 л /  Полезный объем холод. камеры: 166 л  
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'SAMSUNG RB31FSRNDEF', N'Тип холодильника: двухкамерный. /  Общий объем холодильника: 331 л. / Полезный объем холод. камеры: 212 л.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'INDESIT NBS 18 AA UA', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 339 л. / Полезный объем холод. камеры: 233 л. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'LG GA-B419SQCL ', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 354 л. / Полезный объем холод. камеры: 225 л. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'SNAIGE FR-275.1101AA ', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 260 л. / Полезный объем холод. камеры: 201 л. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'INDESIT NTS 14 AA (UA) ', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 249 л. / Полезный объем холод. камеры: 194 л. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'BOSCH KGV39VW31', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 347 л. / Полезный объем холод. камеры: 250 л. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ATLANT XM-6025-100', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 384 л. / Полезный объем холод. камеры: 225 л.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'LG GA-B419SEQL',N'Тип холодильника: двухкамерный. / Общий объем холодильника: 354 л. / Полезный объем холод. камеры: 225 л.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'INDESIT NBS 20 AA (UA) ', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 363 л. / Полезный объем холод. камеры: 233 л.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'SAMSUNG RB31FSRNDWW ', N'Тип холодильника: двухкамерный. / Общий объем холодильника: 331 л. / Полезный объем холод. камеры: 212 л.
					Полезный объем мороз. камеры: 98 л. / Дисплей: нет. / Тип управления: электронное.
					No Frost (Frost Free) : холодильное+морозильное отделения / Уровень шума: 37 дБ. / Габариты (ВхШхГ): 185x59,5x66,8 см.
...
values (2)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Плиты',NULL from [dbo].[Categories]
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'NORD 100-2В Белая ', N'Тип: газовая. / Газ-контроль: нет. / Зоны нагрева: газовые. / Материал решеток поверхности: эмалированные. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'GRETA 1470-0012 (WM)',N'Тип: газовая. / Газ-контроль: нет. / Зоны нагрева: газовые. / Материал решеток поверхности: эмалированные. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ZANUSSI ZCE9550G1W', N'Тип: электрическая. / Зоны нагрева: электрические. / Материал решеток поверхности: нет. / Тип духовки: электрическая.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'KAISER HGG 52511 W ', N'Тип: газовая. / Газ-контроль: поверхности+духовки. / Зоны нагрева: газовые. / Материал решеток поверхности: чугунные. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'HANSA FCEW 53000', N'Тип: электрическая. / Зоны нагрева: электрические. / Материал решеток поверхности: нет. / Тип духовки: электрическая. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'HANSA FCMW53050 ', N'Тип: комбинированная (газ+электро). / Газ-контроль: нет. / Зоны нагрева: газовые, электрические. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'GEFEST 6100-01 ', N'Тип: газовая. / Газ-контроль: духовки. / Зоны нагрева: газовые. / Материал решеток поверхности: чугунные.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'GRETA 1470-0016 (W)', N'Тип: газовая. / Газ-контроль: нет. / Зоны нагрева: газовые. / Материал решеток поверхности: эмалированные. 
					Тип духовки: газовая. / Полезный объем: 54 л. / Гриль: нет. / Конвекция: нет. / Таймер: нет. / Подсветка: нет.
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'GRETA 1470-0007 (WM) ', N'Тип: газовая. / Газ-контроль: нет. / Зоны нагрева: газовые. / Материал решеток поверхности: эмалированные. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ELECTROLUX EKK 954507 W ', N'Тип: комбинированная (газ+электро). / Газ-контроль: поверхности. / Зоны нагрева: газовые. / Материал решеток поверхности: чугунные. 
...
values (3)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Стиральные машины',NULL from [dbo].[Categories]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 4700,1,2015-06-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'INDESIT WISN 821 UA ', N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 800 об/мин. / Класс энергопотребления: А+. 
					Дисплей: нет. / Количество программ: 16. / Габариты (ВхШхГ) : 85x59,5x42 см. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ZANUSSI ZWSE 680 V', N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 800 об/мин. / Класс энергопотребления: А++. 
					Дисплей: нет. / Количество программ: 14. / Габариты (ВхШхГ) : 85х59,5х37,7 см. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ZANUSSI ZWSE 7120 V ',N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 1200 об/мин. / Класс энергопотребления: А++. 
					Дисплей: есть. / Количество программ: 14. / Габариты (ВхШхГ) : 85х59,5х37,7 см. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'WHIRLPOOL AWS 63013', N'Тип: узкая. / Количество белья при стирке: 6 кг. / Скорость отжима: 1000 об/мин. / Класс энергопотребления: А+++. 
					Дисплей: есть. / Количество программ: 18. / Габариты (ВхШхГ) : 84,5х59,5х45,3 см. / Вес: 61 кг. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ELECTROLUX EWS1266CI ', N'Тип: узкая. / Количество белья при стирке: 6 кг. / Скорость отжима: 1200 об/мин. / Класс энергопотребления: А+++.
					Дисплей: есть. / Количество программ: 14. / Габариты (ВхШхГ) : 85х59,5х37,7 см. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'INDESIT IWSD 51051 UA ', N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 1000 об/мин. / Класс энергопотребления: А+. 
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ZANUSSI ZWSE 7100 VS ',N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 1000 об/мин. / Класс энергопотребления: А++.
					Дисплей: есть. / Габариты (ВхШхГ) : 85x59,5x37,7 . / Цвет:белый/серебристый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ELECTROLUX EWS1052NDU', N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 1000 об/мин. / Класс энергопотребления: А++.
					Дисплей: нет. / Количество программ: 14. / Габариты (ВхШхГ) : 85х59,5х37,7. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'LG F80C3LD', N'Тип: узкая. / Количество белья при стирке: 5 кг. / Скорость отжима: 800 об/мин./ Класс энергопотребления: А++. 
					Дисплей: нет. / Количество программ: 9. / Габариты (ВхШхГ) : 85x60x44 см. / Вес: 59 кг. / Цвет:белый.' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'GORENJE W 7202/S ', N'Тип: узкая. / Количество белья при стирке: 7 кг. / Скорость отжима: 1000 об/мин. / Класс энергопотребления: А++. 
...
values (NULL)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Спортивные товары',NULL from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
select MAX(Id),'Ru',N'Беговые дорожки',NULL from [dbo].[Categories]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'EnergyFIT EF-6606B ', N'Назначение: Домашние / конструкция: складные / особенности: транспортировочные ролики, подставка для аксессуаров
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N' EnergyFIT EF-5501В ', N'Назначение: Домашние / Конструкция: Складные / Особенности: Транспортировочные ролики, Подставка для аксессуаров
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'EnergyFIT EF-7705A ', N'Назначение: Домашние / Конструкция: Складные / Особенности: Транспортировочные ролики, Подставка для аксессуаров
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'InterAtletika Jessie KL-803',N'Назначение: Домашние / Конструкция: Складные / Особенности: Транспортировочные ролик, / Максимальный вес пользователя: 100 кг
					Регулировка угла наклона: Механическая' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'ProForm Endurance S9 (PETL99714) ', N'Назначение: Домашние / Конструкция: Складные / Особенности: Вентилятор / Максимальная скорость: 20 км/ч
					Максимальный вес пользователя: 135 кг / Регулировка угла наклона: Электрическая' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'NordicTrack T15 (NETL14711)',N'Назначение: Домашние / Конструкция: Складные / Особенности: Вентилятор / Максимальная скорость: 22 км/ч
					Максимальный вес пользователя: 159 кг / Регулировка угла наклона: Электрическая' from [dbo].[Products]

INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Spirit Esprit XT-485 ',N'Назначение: Домашние / Конструкция: Складные / Особенности: Транспортировочные ролики, Подставка для аксессуаров, Держатель для бутылки, Вентилятор
...
select  MAX(Id) , 7000,1,2015-09-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Гантель наборная Newt 17.5 кг (TI-968-745-17)', N'Тип: Гантели / Вид замка: Винтовой / Форма грифа: Прямая / Длина: 33 см' from [dbo].[Products]
...
select  MAX(Id) , 7000,1,2015-09-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU','Alpen Sport II 10x25 Green (920296)', N'Тип: Бинокль / Кратность приближения: 10х / Диаметр объектива: 25 мм / Вес: 0.2 кг' from [dbo].[Products]
...
select  MAX(Id) , 7000,1,2015-09-07   from [dbo].[Categories]
INSERT INTO [dbo].[ProductTranslations] ([Id],[LanguageId],[Name],[Description])
Select MAX(Id),'RU',N'Бинокль Zeiss Victory HT 10х42 524529 (7120216)',N'Тип: Бинокль / Кратность приближения: 10x / Диаметр объектива: 42 мм / Вес: 0.8 кг' from [dbo].[Products]
