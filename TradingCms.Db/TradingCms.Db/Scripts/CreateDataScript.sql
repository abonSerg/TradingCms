...
SELECT MAX(Id),@lang,N'Планшеты',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Электронные книги',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Телефоны, MP3, GPS',NULL from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)

INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Смартфоны',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'MP3-плееры',NULL from [dbo].[Categories]
...
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Зарядные устройтсва ',NULL from [dbo].[Categories]
...
values (NULL)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Бытовая техника',NULL from [dbo].[Categories]
INSERT INTO [dbo].[Categories]([TopId])
values (1)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Холодильники',NULL from [dbo].[Categories]
...
values (2)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Плиты',NULL from [dbo].[Categories]
...
values (3)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Стиральные машины',NULL from [dbo].[Categories]
...
values (NULL)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Спортивные товары',NULL from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Беговые дорожки',NULL from [dbo].[Categories]
...
values (2)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Велотренажеры',NULL from [dbo].[Categories]
...
values (3)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Гантели, диски',NULL from [dbo].[Categories]
...
values (NULL)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Активный отдых и туризм',NULL from [dbo].[Categories]

INSERT INTO [dbo].[Categories]([TopId])
values (1)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Лодки',NULL from [dbo].[Categories]
...
values (2)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Бинокли',NULL from [dbo].[Categories]
...
values (3)
INSERT INTO [dbo].[CategoryTranslations] ([Id],[LanguageId],[Name],[Description])
SELECT MAX(Id),@lang,N'Рации',NULL from [dbo].[Categories]
