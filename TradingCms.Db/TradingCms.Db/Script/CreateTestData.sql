...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[Products_tr] ([Id],[Languagecode],[Name],[Description])
Select MAX(Id),'RU',N'Автомобильное зарядное устройство E-Power MicroUSB', 'Тип: Автомобильные / Подходит для зарядки: Электронных книг, Планшетов, Мобильных телефонов
					Количество USB-портов: 1 / Дополнительные характеристики: LED индикация процесса зарядки / Цвет: Black / Гарантия: 6 месяцев' from [dbo].[Products]
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[Products_tr] ([Id],[Languagecode],[Name],[Description])
Select MAX(Id),'RU',N'Автомобильное зарядное устройство E-Power кабель MicroUSB', '' from [dbo].[Products]


INSERT INTO [dbo].[Products] ([CategoryId],[Price],[IsAvailable],[CreateDate])
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[Products_tr] ([Id],[Languagecode],[Name],[Description])
Select MAX(Id),'RU',N'Сетевое зарядное устройство', '' from [dbo].[Products]
...
select  MAX(Id) , 3700,1,2015-05-07   from [dbo].[Categories]
INSERT INTO [dbo].[Products_tr] ([Id],[Languagecode],[Name],[Description])
Select MAX(Id),'RU',N'ATLANT XM-6025-100', 'Тип холодильника: двухкамерный. / Общий объем холодильника: 384 л. / Полезный объем холод. камеры: 225 л.
